                                        ...
                                        <div class="col d-flex align-items-center justify-content-between">
                                            <div class="cart_single_caption pl-2">
                                                ...
                                                <h4 class="fs-md ft-medium mb-3 lh-1">TK
                                                    {{ $cartItem->rel_to_product->after_discount }} x  {{ $cartItem->quantity }}</h4>
                            ...
                            <ul class="list-group list-group-sm list-group-flush-y list-group-flush-x">
                                ...
                                <li class="list-group-item d-flex text-dark fs-sm ft-regular">
                                    <span>Discount</span> <span class="ml-auto text-dark ft-medium">TK
                                        {{ number_format(session('discount'), 2) }}</span>
                                </li>
                                <li class="list-group-item d-flex text-dark fs-sm ft-regular">
                                    <span>Total</span> <span class="ml-auto text-dark ft-medium" id="grandTotal">TK
                                        {{ number_format(round(session('total')), 2) }}</span>
                                </li>
                            </ul>
                        </div>
                        {{-- <div>
...
@section('footer_body')
    <script>
        $('.deliveryLocation').click(function() {
            ...
            let grandTotal = formatter.format({{ session('total') }} + parseInt(charge));
