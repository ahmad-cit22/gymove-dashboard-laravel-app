                    ...
                    <div class="d-block border rounded mfliud-bot">
                        <div class="dashboard_author px-2 py-5">
                            ...
                            <div class="dash_caption">
                                <h3 class="fs-lg ft-medium mb-0 lh-1">
                        ...
                        <div class="dashboard_author">
                            ...
                            <ul class="dahs_navbar">
                                ...
                                <li><a href="wishlist.html" class="active"><i class="lni lni-heart mr-2"></i>Wishlist</a>
                                </li>
                ...
                <div class="col-12 col-md-12 col-lg-8 col-xl-8 text-center">
                    ...
                    <div class="row align-items-center">
                        @if ($wishItems->count() > 0)
                                            ...
                                            <div class="text-left">
                                                <div class="text-center">
                                                    <h5 class="fw-bolder fs-md mb-0 lh-1 mb-1"><a
                                                            href="{{ route('product.single', $wishItem->rel_to_product->slug) }}">{{ $wishItem->rel_to_product->product_name }}</a>
                                                    </h5>
                                                    <div class="elis_rty"><span class="ft-bold fs-md text-dark">TK
                                                            {{ $wishItem->rel_to_product->after_discount }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            @endforeach
                        @else
                            <p class="mx-auto text-danger">Your wishlist is currently empty!</p>
                        @endif
