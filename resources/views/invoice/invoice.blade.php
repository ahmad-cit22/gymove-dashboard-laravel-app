...
<body>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="fullTable"
        ...
        @php
            $orderDetails = App\Models\Order::where('order_id', $order_id)->first();
            $billingDetails = App\Models\BillingDetails::where('order_id', $order_id)->first();
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td
                                                            ...
                                                            <small>{{ $orderDetails->created_at->format('d-M-Y') }}</small>
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            ...
                                            @foreach ($orderProducts as $orderItem)
                                                <tr>
                                                    ...
                                                    <td style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #1e2b33;  line-height: 18px;  vertical-align: top; padding:10px 0;"
                                                        align="right">{{ $orderItem->rel_to_product->after_discount }}
                                                    </td>
                                                </tr>
                                                <tr>
        ...
        <tbody>
            <tr>
                <td>
                    <table width="600" border="0" cellpadding="0" cellspacing="0" align="center"
                        class="fullTable" bgcolor="#ffffff">
                        <tbody style="width: 300px; margin-left: auto">
                            <tr>
                                <td>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td
                                                    style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e; line-height: 22px; vertical-align: top; text-align:right; ">
                                                    BDT
                                                    {{ number_format($orderDetails->sub_total, 2) }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                ...
                                                <td
                                                    style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e; line-height: 22px; vertical-align: top; text-align:right; ">
                                                    BDT
                                                    {{ number_format($orderDetails->charge, 2) }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                ...
                                                <td
                                                    style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #646a6e; line-height: 22px; vertical-align: top; text-align:right; ">
                                                    BDT
                                                    {{ number_format($orderDetails->discount, 2) }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td
                                                ...
                                                <td
                                                    style="font-size: 12px; font-family: 'Open Sans', sans-serif; color: #000; line-height: 22px; vertical-align: top; text-align:right; ">
                                                    <strong> BDT
                                                        {{ number_format($orderDetails->total, 2) }}</strong>
                                                </td>
                                            </tr>
                                            {{-- <tr>
                                                <td
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td
                                                                    ...
                                                                    NY<br> 4468, United States<br> T: 202-555-0171
                                                                </td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
